...
class AdminUserRecordTest extends TestCase
{
    ...
    public function test_admin_user_record()
    {
        ...
        $attendance = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$thisMonth])->orderby('date', 'ASC')->first();
    ...
    public function test_admin_user_sub_month_record()
    {
        ...
        $currentMonth = Carbon::createFromFormat('Y/m', $dateString);
        $thisMonth = $currentMonth->format('Y/m');
        $attendances = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$thisMonth])->orderby('date', 'DESC')->get();
        $attendance = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$thisMonth])->orderby('date', 'DESC')->first();
        ...
        $attendances = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$lastMonth])->orderby('date', 'ASC')->get();
        $attendance = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$lastMonth])->orderby('date', 'ASC')->first();
    ...
    public function test_admin_user_add_month_record()
    {
        ...
        $attendances = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$nextMonth])->orderby('date', 'ASC')->get();
        $attendance = Attendance::where('user_id', $user->id)->whereRaw("DATE_FORMAT(date, '%Y/%m') = ?", [$nextMonth])->orderby('date', 'ASC')->first();
